        ...
        <div className="mb8 p4 md:pl8 md:pr8">
            <div className="background-section textGray4">
                ...
                <p className="textRg lineHeightLg fontNormal textGray5 mb4">
                    Use <strong>h</strong> class with scale number to quickly set height of an element. <br/>
                    Height utility classes use a scale from 1 to 24 where each subsequent unit increases by 0.25rem i.e. 1 = 0.25rem, 2 = 0.5rem,..., 24 = 6rem
                </p>
            </div>
